...
echo "DETACHING"
ros2 topic pub /action std_msgs/String "data: Detach box from platform" -1
gz topic -p /polygon/join -m "data:'detach'"

sleep 0.2

ros2 topic pub /action std_msgs/String "data: Move box to table" -1
